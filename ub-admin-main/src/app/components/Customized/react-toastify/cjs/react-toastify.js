...
var info = require('./info.svg');
var warning = require('./warning.svg');
...
function cssTransition(_ref) {
    var enter = _ref.enter,
        ...
        appendPosition =
        _ref$appendPosition === void 0 ? false : _ref$appendPosition;
...
function ProgressBar(_ref) {
    ...
    var classNames = cx(
        ...
        ((_cx = {}), (_cx[RT_NAMESPACE + '__progress-bar--rtl'] = rtl), _cx),
        className,
    );
    var animationEvent =
        ((_animationEvent = {}),
            (_animationEvent[
                controlledProgress && progress >= 1 ? 'onTransitionEnd' : 'onAnimationEnd'
    ...
    (function(_Component) {
        ...
        function Toast() {
            ...
            _this.onDragStart = function(e) {
                ...
                _this.drag.removalDistance =
                    _this.ref.offsetWidth * (_this.props.draggablePercent / 100);
            };
            ...
            _this.onDragMove = function(e) {
                if (_this.flag.canDrag) {
                    ...
                    _this.drag.start !== _this.drag.x &&
                        (_this.flag.canCloseOnClick = false);
                    _this.ref.style.transform = 'translateX(' + _this.drag.deltaX + 'px)';
                    _this.ref.style.opacity =
                        1 - Math.abs(_this.drag.deltaX / _this.drag.removalDistance);
                }
            };
        ...
        _proto.render = function render() {
            var _cx,
                _this2 = this;
            var additional = additionalChilds(this.props.type);
            ...
            var toastProps = {
                className: cx(
                    ...
                    ((_cx = {}), (_cx[RT_NAMESPACE + '__toast--rtl'] = rtl), _cx),
                    className,
                ),
            };
...
var ToastContainer =
    ...
    (function(_Component) {
        ...
        _proto.componentDidMount = function componentDidMount() {
            ...
            eventManager
                .on(ACTION.SHOW, function(content, options) {
        ...
        _proto.makeCloseButton = function makeCloseButton(
            toastClose,
            toastId,
            type,
        ) {
            ...
            if (React.isValidElement(toastClose) || toastClose === false) {
                ...
                closeButton =
                    this.props.closeButton && typeof this.props.closeButton !== 'boolean' ?
        ...
        _proto.buildToast = function buildToast(content, _ref2) {
            ...
            var toastOptions = {
                ...
                pauseOnHover: typeof options.pauseOnHover === 'boolean' ?
                    options.pauseOnHover :
                    this.props.pauseOnHover,
                pauseOnFocusLoss: typeof options.pauseOnFocusLoss === 'boolean' ?
                    options.pauseOnFocusLoss :
                    this.props.pauseOnFocusLoss,
                draggable: typeof options.draggable === 'boolean' ?
                    options.draggable :
                    this.props.draggable,
                draggablePercent: typeof options.draggablePercent === 'number' &&
                    !isNaN(options.draggablePercent) ?
                    options.draggablePercent :
                    this.props.draggablePercent,
                closeOnClick: typeof options.closeOnClick === 'boolean' ?
                ...
                hideProgressBar: typeof options.hideProgressBar === 'boolean' ?
            ...
            typeof options.onClose === 'function' &&
                (toastOptions.onClose = options.onClose); // add closeToast function to react component only
        ...
        _proto.renderToast = function renderToast() {
            ...
            var collection = newestOnTop ?
                Object.keys(this.collection).reverse() :
                Object.keys(this.collection); // group toast by position
            ...
            return Object.keys(toastToRender).map(function(position) {
                ...
                var props = {
                    className: cx(
                        ...
                        ((_cx = {}),
                            (_cx[RT_NAMESPACE + '__toast-container--rtl'] = _this5.props.rtl),
                            _cx),
...
function dispatchToast(content, options) {
    if (isAnyContainerMounted()) {
        ...
        if (lazy && canUseDom) {
            ...
            reactDom.render(
                React__default.createElement(ToastContainer, containerConfig),
                containerDomNode,
            );
        }
    }
...
eventManager
    .on(ACTION.DID_MOUNT, function(containerInstance) {
        ...
        img style = {
            {
                ...
                paddingRight: '5px',
                marginTop: '0px',
                borderRight: '2px solid var(--darkGrey)',
                marginRight: '5px',
                float: 'left',
            }
        }
