...
class AdvancedSegment extends StatefulWidget {
  const AdvancedSegment({
    ...
    this.borderColor = ColorName.primaryBlue,
    this.onChange,
    this.itemWidth,
...
class _AdvancedSegmentState extends State<AdvancedSegment>
  ...
  void initSizes() {
    ...
    _itemSize = Size(
      ...
      widget.itemWidth ?? maxSize.width + widget.itemPadding.horizontal,
        ...
        return Row(
          ...
          children: widget.segments.entries.map((entry) {
            return GestureDetector(
              onTap: () {
                _handleSegmentPressed(entry.key);
              ...
              child: Container(
                width:
                    MediaQuery.of(context).size.width / widget.segments.length -
                        12,
