...
enum MessageNames {
  ...
  /////////////
  UNSUBSCRIBE_FORM_STREAM = 'UNSUBSCRIBE_FORM_STREAM',
  ...
  SUBSCRIBE_TO_STREAM = 'SUBSCRIBE_TO_STREAM',
  SET_CURRENCY_PAIR_DETAILS = 'SET_CURRENCY_PAIR_DETAILS',
  GET_CURRENCY_PAIR_DETAILS = 'GET_CURRENCY_PAIR_DETAILS',
  ...
  REFRESH_VISIBLE_SECTION = 'REFRESH_VISIBLE_SECTION',
